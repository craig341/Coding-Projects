...
devil_blade = Weapon(name='Devil Blade', price=666, damage=200, speed=1, aim=10, crit_chance=30, rarity='ancient')

long = Weapon(name='aduoawodiuoiawdhioawhodawiohdaiwd', price=0, damage=7, speed=1, aim=0, rarity='special')
developer_sword = Weapon(name='hurt stick', price=999, damage=999, speed=999, aim=100, durability=-1, rarity='special')
