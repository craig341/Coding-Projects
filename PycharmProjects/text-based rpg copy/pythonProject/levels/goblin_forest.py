...
from pythonProject.useful_functions.print_functions import clear
...
def level_1():
    ...
    for i in range(random.randint(9, 15)):
        ...
        if simple_chance(20):
            shop(random_option(
                {shop_dict['Village Shop']: 40,
                 shop_dict['Blacksmith Shop']: 40,
                 shop_dict['Knight Outpost']: 10,
                 shop_dict['Medicine Dealer']: 10,
                 }
            ))
    ...
    while True:
        ...
        if simple_chance(20):
            shop(random_option(
                {shop_dict['Village Shop']: 20,
                 shop_dict['Blacksmith Shop']: 30,
                 shop_dict['Knight Outpost']: 20,
                 shop_dict['Medicine Dealer']: 30,
                 }
            ))
