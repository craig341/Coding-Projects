...
def shop(shop_type):
    ...
    # story_text(f"You entered a {shop_type}")
    ...
    while True:
        ...
        if choice == 1:
            ...
            healthbar(player, fill_bar=min(shop_obj.rest[1], player.max_health - player.health))
        ...
        elif (choice == len(option_labels) and not developer) or (choice == len(option_labels) - 1 and developer):
            break

        elif choice == len(option_labels) and developer:
            summon_item()
